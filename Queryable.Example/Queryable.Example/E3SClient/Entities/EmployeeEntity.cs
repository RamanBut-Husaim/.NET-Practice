...
namespace Queryable.Example.E3SClient.Entities
{
    public class Skills
    {
        [JsonProperty]
    ...
    {
        [JsonProperty]
        private double entityBoost { get; set; }

        [JsonProperty]
        private double documentBoost { get; set; }

        [JsonProperty] private List<string> phone;
        ...
        [JsonProperty]
        private List<string> trainer { get; set; }

        [JsonProperty]
        private List<string> kb { get; set; }
        ...
        [JsonProperty]
        private List<Recognition> recognition { get; set; }
